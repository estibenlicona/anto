...
Toda la separación entre piezas de la vista de listado de células SHALL ser de 12px (`gap-3`): tanto la vertical entre los bloques del contenido (resumen y listado) como la que hay entre las cards del resumen. La pantalla no SHALL mezclar dos medidas distintas de separación, y la medida SHALL ser la misma que usa la vista mensual de ausencias.
