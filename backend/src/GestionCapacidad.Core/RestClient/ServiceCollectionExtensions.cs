...
namespace GestionCapacidad.RestClient;
...
public static class ServiceCollectionExtensions
{
        ...
        where TImplementation : class, TClient
    {
        ...
        RestClientOptions options = BindAndValidateOptions(clientName, section);
        ...
        services.TryAddSingleton<IManagedIdentityTokenProvider, ManagedIdentityTokenProvider>();
        services.TryAddSingleton<IAccessTokenProvider, DefaultAccessTokenProvider>();

        IHttpClientBuilder clientBuilder = services.AddHttpClient(clientName, client =>
        {
    ...
    private static string GetClientName(IConfigurationSection section)
    {
        ...
        return !string.IsNullOrWhiteSpace(section.Path)
            ? section.Path
    ...
    {
        RestClientOptions options = section.Get<RestClientOptions>()
    ...
    private static void ValidateResilienceOptions(string clientName, IConfigurationSection section, RestClientOptions options)
    {
        ...
        IConfigurationSection resilienceSection = section.GetSection(nameof(RestClientOptions.Resilience));
        ResiliencePreset preset = resilience.Preset;
