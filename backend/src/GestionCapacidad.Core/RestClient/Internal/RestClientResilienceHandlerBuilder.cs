...
using Polly.Retry;
using Polly.Timeout;
using RestClientCircuitBreakerOptions = GestionCapacidad.RestClient.Configurations.CircuitBreakerStrategyOptions;
using RestClientRetryOptions = GestionCapacidad.RestClient.Configurations.RetryStrategyOptions;
...
internal static class RestClientResilienceHandlerBuilder
{
    ...
    {
        RestClientRetryOptions retry = resilience.Retry;
