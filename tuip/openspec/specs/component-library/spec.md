...
#### Scenario: Descripción bajo la etiqueta
- **WHEN** una pestaña recibe una descripción
- **THEN** se muestra como una segunda línea bajo la etiqueta, en el estilo de rótulo con peso regular, forma parte del nombre accesible de la pestaña, y la pestaña toma su propio relleno horizontal para que las dos líneas se lean como un bloque bajo la regla

#### Scenario: Lista que encabeza una card
- **WHEN** la lista de pestañas se declara en variante `surface`
- **THEN** se apoya en la superficie sutilísima con el relleno interior de una card y los disparadores apretados, de modo que la primera etiqueta alinea con el contenido de la card y la lista se lee como su encabezado; sin variante, la lista es la fila de siempre
