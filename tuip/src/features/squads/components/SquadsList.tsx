    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        ...
        <FilterButton
          ...
          onChange={(values) => onCriticalitiesChange(values as Criticality[])}
        />
      </div>
      {/*
        La carga y el error ocupan sólo esta zona, no la pantalla entera.
        ...
        mientras los resultados llegan.
      */}
      {loading ? (
        <p className="text-body-sm text-neutral-subtle">Cargando células…</p>
      ) : error ? (
        <Alert
          variant="danger"
