...
El sistema SHALL permitir **Activar** una iniciativa sólo si tiene talla (evaluación guardada) y **Cerrar** sólo si está activa. Las acciones no disponibles SHALL mostrarse deshabilitadas en el menú de la fila. Activar SHALL pedir confirmación indicando que la iniciativa pasará a contar como demanda; cerrar SHALL pedir confirmación.
