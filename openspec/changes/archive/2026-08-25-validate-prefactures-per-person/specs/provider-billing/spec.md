...
- FROM: `### Requirement: Cierres de facturación por período`
- TO: `### Requirement: Prefacturas del período`

- FROM: `### Requirement: Detalle de un cierre`
- TO: `### Requirement: Detalle de una prefactura`

- FROM: `### Requirement: Registro de la factura recibida`
- TO: `### Requirement: Registro de la prefactura recibida`

- FROM: `### Requirement: Objeción de una factura`
- TO: `### Requirement: Objeción de una prefactura`
