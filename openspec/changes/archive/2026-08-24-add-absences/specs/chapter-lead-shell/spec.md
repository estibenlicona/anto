...
- Grupo "Capacidad": Células, Personas, Ausencias, Backlog, Facturación, Plan de carrera
...
- **WHEN** el usuario abre la matriz del span o el plan de una persona
- **THEN** la entrada "Plan de carrera" se muestra activa y el breadcrumb muestra "Plan de carrera"
