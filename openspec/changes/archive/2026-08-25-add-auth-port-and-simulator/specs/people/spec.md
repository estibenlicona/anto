...
**Migration**: Lo reemplaza "Acceso autenticado a la pantalla de Personas", en esta misma capacidad. Para trabajar en esta pantalla en desarrollo hay que levantar la aplicación con el simulador y elegir un perfil con rol de Chapter Lead.
