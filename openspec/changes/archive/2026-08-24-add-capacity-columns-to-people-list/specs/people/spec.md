...
- **THEN** el sistema muestra una página de resultados con una fila por cada persona de esa página, su avatar con iniciales, nombre, correo corporativo, cargo, rol, seniority, modalidad, FTE disponible y utilización, junto con el total de personas y la navegación entre páginas
