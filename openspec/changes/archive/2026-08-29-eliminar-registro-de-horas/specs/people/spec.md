...
- **THEN** la página muestra exactamente dos indicadores, Asignado y Trabajo en DevOps; no hay indicador de reporte de horas, ni botón "Validar", ni panel "Horas por sprint", ni FTE real ni diferencia en puntos; el indicador Asignado muestra el FTE asignado sobre el disponible y lo libre ("0.8 / 1.0 FTE asignado" con "0.2 FTE libre", o "0.0 / 1.0" con "1.0 FTE libre" sin célula)

#### Scenario: Reporte del sprint por validar
- **WHEN** una persona con célula tiene trabajo en el sprint en curso
- **THEN** el detalle no ofrece ningún reporte de horas que validar: no existe el indicador de reporte, ni un estado "Por validar", ni el botón "Validar"; lo trabajado se lee en el indicador Trabajo en DevOps
