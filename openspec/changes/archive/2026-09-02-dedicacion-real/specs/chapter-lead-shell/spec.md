...
La entrada "Dedicación" (pantalla **Dedicación real**, `/app/lead/dedicacion`, en el lugar que ocupaba Backlog) SHALL mostrarse activa también en la dedicación real de una capacidad, cuyo breadcrumb SHALL ser "Plataforma / Dedicación real / <nombre de la persona>"; y SHALL mostrar como badge la cantidad de capacidades **fuera de lo asignado** en el sprint en curso —las que leen "Por encima" o "Por debajo"— cuando es mayor que cero, y ningún badge cuando es cero.
...
- **WHEN** en el sprint en curso hay capacidades del chapter por encima o por debajo de lo asignado
- **THEN** la entrada "Dedicación" muestra esa cantidad como badge; cuando todas leen en línea, sin célula o sin identidad, el badge desaparece
