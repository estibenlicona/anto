...
Los **dos indicadores** SHALL ser: **Asignado** (FTE asignado sobre FTE disponible declarado, la barra de dedicación y lo libre en FTE; "1.0 FTE libre" para una persona sin célula) y **Dedicación real** (para el sprint en curso: el FTE comprometido —los puntos de sus historias en Azure DevOps traducidos a FTE— frente al FTE asignado, sobre la misma barra única del módulo Dedicación real y con las cifras "comprometido / asignado FTE", la lectura como marca de estado con la diferencia en FTE —las mismas reglas y umbrales de la capability `real-dedication`—, y el enlace *Ver dedicación* a `/app/lead/dedicacion/<id>`; "Sin sprint" cuando Azure DevOps no tiene sprints para ella; o, sin identidad vinculada, "Sus items no cuentan" con la acción *Vincular con Azure DevOps*, siempre disponible, que abre el drawer de vinculación por correo). La página SHALL NOT mostrar horas reportadas, reporte del sprint, ni un FTE real ni una diferencia derivados de horas: la plataforma no registra horas, y el trabajo real se lee en los items de DevOps.
...
- **THEN** el sistema abre la dedicación real de esa capacidad en `/app/lead/dedicacion/<id>` con el sprint en curso elegido
...
- **THEN** el indicador de DevOps dice que sus items no cuentan y ofrece "Vincular con Azure DevOps" habilitado, sin condición sobre coincidencias por nombre; al vincular desde el drawer, el encabezado pasa a "DevOps vinculado", el indicador muestra la lectura del sprint en curso y la ficha muestra el usuario y la fecha de vinculación

#### Scenario: Lectura del sprint en la ficha
- **WHEN** se abre el detalle de una persona con identidad DevOps, 1.0 FTE disponible y 80 % de dedicación asignada que comprometió 18 puntos en el sprint en curso, con 26 puntos por FTE
- **THEN** el indicador Dedicación real muestra "0.69 / 0.80 FTE" con la barra única (el comprometido sobre la banda de lo asignado), la lectura "Por debajo" con "−0.11 FTE" y el enlace "Ver dedicación"
