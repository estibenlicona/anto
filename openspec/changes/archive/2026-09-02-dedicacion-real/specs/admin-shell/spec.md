...
El formulario del **Calendario de sprints** SHALL tener exactamente tres campos: *Semanas por sprint*, *Sprints por quarter* y *Puntos por FTE por sprint* (los puntos de historias de usuario que equivalen a 1.0 FTE de dedicación en un sprint; entre 1 y 100). SHALL NOT ofrecer horas por semana ni tolerancia de reporte, ni mostrar tarjetas o textos que describan un reporte de horas o una conversión de horas a FTE: la plataforma no registra horas. La tarjeta de qué usa el calendario SHALL nombrar Dedicación real, que con ese valor traduce a FTE los puntos comprometidos en cada sprint.
...
- **THEN** el formulario carga y muestra la configuración actual servida por el endpoint mockeado —semanas por sprint, sprints por quarter y puntos por FTE por sprint, sin campos de horas ni de tolerancia—, sin título ni descripción de página adicionales a los ya visibles en la navegación y el breadcrumb
